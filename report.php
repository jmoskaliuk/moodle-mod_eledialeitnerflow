<?php
/**
 * Teacher report: overview of all enrolled students' Leitner progress.
 */
...
require(['core/str', 'core/modal_factory', 'core/modal_events'], function(Str, ModalFactory, ModalEvents) {
